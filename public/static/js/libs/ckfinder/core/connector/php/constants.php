...
define('CKFINDER_CONNECTOR_LANG_PATH', CF_DIR.'/lang');
define('CKFINDER_CONNECTOR_CONFIG_FILE_PATH', CF_DIR.'/../../../config.php');
...
define('CKFINDER_CONNECTOR_LIB_DIR', CF_DIR.'/php5');
