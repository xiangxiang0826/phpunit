...
*/
$baseUrl = $host_root_url;//$host_root_url在File_IndexController->connectorAction中定义
...
$baseDir = $host_root_dir . '/';//$host_root_dir在File_IndexController->connectorAction中定义
...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . '_thumbs',
		'directory' => dirname($baseDir) . '/_thumbs',
		'enabled' => false,
		'directAccess' => false,
		'maxWidth' => 60,
		'maxHeight' => 60,
...
*/
$config['HtmlExtensions'] = array('html', 'htm', 'phtml', 'xml', 'js', 'php');
