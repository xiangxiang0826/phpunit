...
// 
/*
 * @auther etong <zhoufeng@wondershare.cn>
 * @version $v1 2014/09/29 14:28$
 * 为版本校验添加规则
 * 使用方式：
    $('#form').validate({
         rules: {
...
jQuery.validator.addMethod("version", function(value, element) {
    var version = /^[1-9]\.[0-9]{1,2}\.[0-9]{1,2}\.[0-9]{6}$/;
    return this.optional(element) || (version.test(value));
}, "\u7248\u672c\u683c\u5f0f\u9519\u8bef\uff08\u793a\u4f8b\u003a\u0031\u002e\u0031\u0030\u002e\u0031\u0030\u002e\u0031\u0032\u0033\u0034\u0035\u0036\uff09");
// 上述提示为：版本格式错误（示例:1.10.10.123456）