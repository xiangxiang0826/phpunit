<?php
require_once APPLICATION_PATH.'/modules/operation/controllers/ClientfeedbackController.php';
class dbMockClient{
...
class Operation_ClientFeedbackControllerTest extends EZX_Framework_TestCase {
	public $controller;
	public function setUp(){
		parent::setUp();
		$this->controller = $this->createMockController('Operation_ClientFeedbackController', $this->request, $this->response);
	}
    ...
    public function testIndexAction(){
    	...
    	$productMockMethods = array(
    			'GetList' => array('list'=>array(array('id'=>1,'name'=>'test')))
    	);
    	...
    	//assert
    	$this->assertSame(array(1=>array('id'=>1,'name'=>'test')),$this->controller->view->product);    	
    ...
    public function testDetailAction(){
    	...
    	//mock part
    	$onlineFeedbackMockMethods = array(
    			'getFeedbackById' => array('product_id'=>1, 'device_id'=>1, 'platform'=>'ios', 'app_id'=>1,'label'=>'test')
    	);
    	...
    	$enterpriseMockMethods = array(
    			'getByPlatform' => array(),
    			'getByLabel' => array('id'=>1,'label'=>'test')
    	);
